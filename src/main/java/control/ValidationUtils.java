...
public class ValidationUtils {
    ...
    public static boolean isJsonValid(JsonSchema schemaNode, JsonNode string) throws ProcessingException
    {
        ProcessingReport report = ((JsonSchema) schemaNode).validate(string);
